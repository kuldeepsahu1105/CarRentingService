        ...
        <div class="row">
          <div class="signup_wrap">
            <div class="col-md-12 col-sm-6">
                <form  method="post" name="signup" onSubmit="return valid();" action="doregister.jsp">
                ...
                <div class="form-group checkbox">
                  ...
                  <label for="terms_agree">I Agree with <a href="page.jsp?type=terms">Terms and Conditions</a></label>
                </div>
                <div class="form-group">
