...
<%  
        PreparedStatement ps1 = con.prepareStatement("SELECT * from  tblbrands");
...
%>	
										<tr>
											<td><%=i++%></td>
											<td><%= rs1.getString("BrandName") %></td>
											<td><%= rs1.getString("CreationDate") %></td>
											<td><%= rs1.getString("UpdationDate") %></td>
<td><a href="edit-brand.jsp?id=<%= rs1.getInt("id") %>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
<a href="deletebrand.jsp?id=<%= rs1.getInt("id") %>" onclick="return confirm('Do you really want to delete?');"><i class="fa fa-close"></i></a></td>
										</tr>
										<% } %>
