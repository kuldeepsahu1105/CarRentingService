							...
							<div class="col-md-10">
								<div class="panel panel-default">
									...
									<div class="panel-body">
                                                                            <form method="post" class="form-horizontal" enctype="multipart/form-data" action="dochimage5.jsp">
...
<%  
        ...
        PreparedStatement ps1 = con.prepareStatement("SELECT Vimage5 from tblvehicles where tblvehicles.id=?");
        ps1.setString(1, id);
