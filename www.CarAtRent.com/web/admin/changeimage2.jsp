							...
							<div class="col-md-10">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form method="post" class="form-horizontal" enctype="multipart/form-data" action="dochimage2.jsp">
...
<%  
        ...
        PreparedStatement ps1 = con.prepareStatement("SELECT Vimage2 from tblvehicles where tblvehicles.id=?");
        ps1.setString(1, id);
...
<div class="col-sm-8">
<img src="img/vehicleimages/<%= rs1.getString("Vimage2") %>" width="300" height="200" style="border:solid 1px #000">
</div>
<% } %>
</div>
