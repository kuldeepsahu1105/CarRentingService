				...
				<div class="row">
							...
							<div class="col-md-10">
								<div class="panel panel-default">
									...
									<div class="panel-body">
                                                                            <form method="post" name="chngpwd" class="form-horizontal" onSubmit="return valid();" action="updatebrand.jsp">
  	        	  ...
  	        	  <%//if (flag<=0) {%><div class="errorWrap"><strong>ERROR</strong>:<%//out.print("Something went wrong. Please try again");%> </div><%// } %>
                        <%//if (flag>0) {%>  <div class="succWrap"><strong>SUCCESS</strong>:<%//out.print("Testimonial Successfully (Active/Inactive)");%> </div>
                          ...
                          <%  
    PreparedStatement ps1 = con.prepareStatement("select * from tblbrands where id=?");
    ps1.setString(1, id);
...
%>
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control" value="<%= rs1.getString("BrandName") %>" name="brand" id="brand" required>
