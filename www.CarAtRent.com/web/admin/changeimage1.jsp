							...
							<div class="col-md-10">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form method="post" class="form-horizontal" enctype="multipart/form-data" action="dochimage1.jsp">
...
<div class="form-group">
    <%  
        ...
        PreparedStatement ps1 = con.prepareStatement("SELECT Vimage1 from tblvehicles where tblvehicles.id=?");
        ps1.setString(1, id);
...
<div class="col-sm-8">
<img src="img/vehicleimages/<%= rs1.getString("Vimage1") %>" width="300" height="200" style="border:solid 1px #000">
</div>
<% } %>
</div>
