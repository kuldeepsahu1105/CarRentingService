                        ...
                        <%//if (flag>0) {%>  <div class="succWrap"><strong>SUCCESS</strong>:<%//out.print("Testimonial Successfully (Active/Inactive)");%> </div>
                          <%// } %>
									...
									<div class="panel-body">
                                                                            <form method="post" class="form-horizontal" enctype="multipart/form-data" action="insertvehicle.jsp">
...
<%  
        PreparedStatement ps1 = con.prepareStatement("select id,BrandName from tblbrands");
        ResultSet rs1 = ps1.executeQuery();  
        int i=1;                          
        while(rs1.next())
                    {                     
%>	
<option value="<%= rs1.getInt("id") %>"><%= rs1.getString("BrandName") %></option>
<% } %>
